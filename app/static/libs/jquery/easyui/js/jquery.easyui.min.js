...
_6af(_6ac,_6ad);
  ...
  var row=opts.finder.getRow(_6ac,_6ad);
  if(opts.onMouseOverRow){
    opts.onMouseOverRow.call(_6ac,e,_6ad,row);
  }
...
opts.finder.getTr(_6ac,_6ad).removeClass("datagrid-row-over");
   var row=opts.finder.getRow(_6ac,_6ad);
   if(opts.onMouseOutRow){
      opts.onMouseOutRow.call(_6ac,e,_6ad,row);
   }
}
};
};
