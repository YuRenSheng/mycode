...
user_router:get("/security/send_email",function(req,res,next)-- 發送驗證碼
...
user_router:get("/security/verify_psw",function(req,res,next) -- 驗證密碼
    local user = res.locals
    local userid = tonumber(user.userid)
...
user_router:post("/security/verify_edit",function(req,res,next)
...
user_router:post("/security/change_psw",function(req,res,next)
...
user_router:get("/userinfo/query",function(req,res,next)
...
user_router:post("/userinfo/edit",function(req,res,next)
